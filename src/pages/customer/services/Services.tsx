        ...
        const fetchServices = async () => {
            ...
            try {
                ...
                if (svcRes?.data) {
                    ...
                    setTotalPages(svcRes.data.pagination?.totalPages || svcRes.data.totalPages || 1);
                } else {
                    setDbServices([]);
                    setTotalPages(1);
                }
        ...
        <div className="bg-white text-left">
            ...
            <section className="py-20 md:py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-slate-100" style={{ backgroundColor: '#F8FAFC' }}>
                ...
                <div
                    ...
                    className={`flex overflow-x-auto gap-6 md:gap-8 pb-8 pt-4 scrollbar-hide -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 ${isDragging ? 'cursor-grabbing select-none snap-none' : 'cursor-grab snap-x snap-mandatory'
                        }`}
