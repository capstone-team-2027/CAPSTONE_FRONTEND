  ...
  vi: {
    translation: {
      ...
      profile: {
        ...
        historyTooltip: "Xem chi tiết trong Lịch sử dịch vụ",
        ...
        tabs: {
          ...
          vehicles: "Xe sở hữu",
          quoteTracking: "Theo dõi báo giá",
      ...
      history: {
        ...
        description: "Xem lại lịch sử dịch vụ, bảo dưỡng và các hóa đơn dịch vụ của bạn.",
      ...
      appointments: {
        ...
        cancelFail: "Không thể hủy lịch hẹn.",
        cancelError: "Đã xảy ra lỗi khi hủy lịch hẹn.",
        loadError: "Không thể lấy danh sách lịch hẹn.",
        loadErrorConnection: "Đã xảy ra lỗi khi kết nối với máy chủ.",
        loading: "Đang tải lịch hẹn...",
        loadErrorTitle: "Không thể tải danh sách lịch hẹn",
        retry: "Thử lại",
        status: {
        ...
        historyTitle: "Lịch sử đặt lịch hẹn",
        historyDesc: "Theo dõi trạng thái, thời gian và chi tiết các lịch hẹn dịch vụ của bạn.",
        bookNew: "Đặt lịch hẹn mới",
        serviceBookingsTab: "Lịch đặt dịch vụ",
        supportBookingsTab: "Lịch đặt hỗ trợ",
        searchPlaceholder: "Tìm theo xe, biển số, mã hẹn...",
        filter: {
          all: "Tất cả",
          confirmed: "Đã xác nhận",
          inProgress: "Đang làm",
        ...
        noSearchQueryResults: "Thử thay đổi từ khóa hoặc điều kiện lọc của bạn.",
        noServiceBookings: "Bạn chưa có lịch đặt dịch vụ nào tại Gara của chúng tôi.",
        noSupportBookings: "Bạn chưa có lịch đặt hỗ trợ, tư vấn nào.",
        bookNowLink: "Đặt lịch hẹn ngay",
        requestSupportNow: "Yêu cầu hỗ trợ ngay",
        supportRequestLabel: "Yêu cầu tư vấn hỗ trợ",
        noDetailedNotes: "Không có ghi chú chi tiết.",
        estCost: "Chi phí ước tính",
        consultationCost: "Chi phí tư vấn",
        free: "Miễn phí",
        viewDetail: "Xem chi tiết",
        cancel: "Hủy lịch hẹn",
        apptDetailTitle: "Phiếu chi tiết lịch hẹn",
        apptStatus: "Trạng thái lịch hẹn:",
        apptTime: "Thời gian hẹn",
        apptBay: "Khoang phục vụ",
        advisorSuffix: "(Cố vấn)",
        apptVehicle: "Phương tiện đăng ký",
        apptServices: "Hạng mục dịch vụ",
        comboBadge: "Combo",
        singleServiceBadge: "Dịch vụ lẻ",
        consultationContent: "Nội dung yêu cầu tư vấn",
        apptNotes: "Ghi chú kỹ thuật / Yêu cầu",
        consultationCostLabel: "CHI PHÍ TƯ VẤN:",
        apptTotal: "TỔNG CHI PHÍ ƯỚC TÍNH:",
        cancelAppt: "Hủy lịch hẹn",
        consultationRequestLabel: "Yêu cầu tư vấn",
        comboAndSingle: "Combo & Dịch vụ lẻ",
        comboPackageLabel: "Gói dịch vụ (Combo)",
        supportRequest: "Hỗ trợ tư vấn kỹ thuật",
        other: "Khác",
      ...
      quoteTracking: {
        ...
        searchPlaceholder: "Tìm mã báo giá, xe, hạng mục, phụ tùng...",
        ...
        emptyDesc: "Các báo giá liên quan đến xe của bạn sẽ được hiển thị tại đây.",
        table: {
          code: "Đơn báo giá",
          customer: "Khách hàng",
          vehicle: "Xe",
        ...
        moreItems: "khác",
        detail: "Chi tiết",
        unnamedItem: "Hạng mục #{{id}}",
        status: {
          pending: "Chờ duyệt",
          approved: "Đã duyệt",
          pendingDeposit: "Chờ cọc",
          rejected: "Từ chối",
          unknown: "Không rõ"
        },
        modal: {
          codeLabel: "Báo giá {{code}}",
          title: "Chi tiết báo giá",
          viewPdf: "Xem dưới dạng PDF",
          customer: "Khách hàng",
          name: "Tên",
          phone: "SĐT",
          vehicle: "Phương tiện",
          ...
          vehicleName: "Tên xe",
          status: "Trạng thái",
          awaitingDeposit: "Chờ cọc {{count}} phụ tùng",
          depositNeeded: "Cần thu cọc: {{amount}}",
          approvedAt: "Duyệt lúc: {{date}}",
          createdAt: "Ngày tạo",
          approvalMethod: "Phương thức duyệt: {{method}}",
          itemsTitle: "Hạng mục báo giá",
          itemsCount: "{{count}} hạng mục",
          partsSection: "Phụ tùng ({{count}})",
          servicesSection: "Dịch vụ ({{count}})",
          issueCol: "Hạng mục lỗi",
          partCol: "Phụ tùng",
          serviceCol: "Dịch vụ",
          qtyCol: "SL",
          unitPriceCol: "Đơn giá",
          repairPriceCol: "Giá sửa chữa",
          totalCol: "Thành tiền",
          customPartWaiting: "Phụ tùng đặt riêng · Cần cọc: {{amount}}",
          customPartPaid: "Phụ tùng đặt riêng · Đã cọc",
          note: "Ghi chú",
          noNote: "Không có ghi chú.",
          total: "Tổng cộng",
          discussWithReception: "Trao đổi báo giá với nhân viên",
          reject: "Từ chối",
          approve: "Duyệt báo giá",
          processing: "Đang xử lý...",
          payDeposit: "Thanh toán cọc"
        },
        rejectModal: {
          badge: "Từ chối báo giá",
          title: "Nhập lý do từ chối",
          label: "Lý do từ chối",
          placeholder: "Nhập lý do bạn không đồng ý với báo giá...",
          cancel: "Hủy",
          confirm: "Xác nhận từ chối",
          reasonRequired: "Vui lòng nhập lý do từ chối báo giá."
        },
        depositModal: {
          title: "Thanh toán tiền cọc",
          subtitle: "Quét mã VietQR để thanh toán cọc phụ tùng đặt riêng.",
          amountDue: "Số tiền cần cọc",
          quantityLabel: "Số lượng: {{qty}} · Cọc 30%",
          customer: "Khách hàng",
          scanQr: "Quét mã VietQR",
          qrAlt: "Mã VietQR thanh toán cọc",
          accountNumber: "Số tài khoản",
          transferContent: "Nội dung CK",
          waitingConfirm: "Hệ thống đang tự động chờ xác nhận tiền cọc...",
          successTitle: "Thanh toán cọc thành công!",
          successDesc: "Hệ thống đã ghi nhận tiền cọc cho báo giá {{code}}.",
          close: "Đóng"
        },
        pdfModal: {
          title: "Báo giá {{code}} · Xem trước PDF",
          download: "Tải về",
          iframeTitle: "Xem trước báo giá PDF"
        },
        errors: {
          rejectFailed: "Không thể từ chối báo giá.",
          approveFailed: "Không thể duyệt báo giá.",
          pdfFailed: "Không thể tạo file PDF."
        }
      },
      tracking: {
        title: "Theo dõi tiến độ sửa chữa",
        description: "Cập nhật trạng thái sửa chữa xe của bạn theo thời gian thực.",
        loading: "Đang tải dữ liệu theo dõi...",
        loadErrorTitle: "Không thể tải dữ liệu",
        retry: "Thử lại",
        emptyTitle: "Không có xe nào đang ở trong xưởng",
        emptyDesc: "Hiện tại bạn không có lệnh sửa chữa nào đang được thực hiện hoặc vừa hoàn thành.",
        bookNow: "Đặt lịch bảo dưỡng ngay",
        filters: {
          active: "Đang tiến hành",
          completed: "Đã hoàn thành"
        },
        noVehicleFoundTitle: "Không tìm thấy xe",
        noVehicleActiveDesc: "Tuyệt vời! Bạn không có chiếc xe nào đang phải sửa chữa.",
        noVehicleCompletedDesc: "Bạn chưa có chiếc xe nào vừa hoàn thành sửa chữa gần đây.",
        unknownPlate: "Xe không rõ",
        vehicle: "Phương tiện",
        plate: "Biển số",
        vehicleName: "Tên xe",
        returned: "Đã trả xe",
        estimatedFinish: "Dự kiến hoàn thành",
        workProgress: "Tiến độ công việc",
        awaitingHandover: "Đang kiểm tra trước khi giao xe",
        itemsCompleted: "{{done}}/{{total}} hạng mục hoàn tất",
        repairItemsTitle: "Hạng mục sửa chữa",
        unnamedItem: "Hạng mục #{{id}}",
        timeline: "Mốc thời gian",
        entryTime: "Tiếp nhận xe",
        actualFinish: "Hoàn tất thực tế",
        footerNote: "Dữ liệu được cập nhật tự động từ xưởng dịch vụ AGM Intelligent",
        orderStatus: {
          inspecting: "Đang kiểm tra",
          waitingForParts: "Chờ phụ tùng",
          inProgress: "Đang sửa chữa",
          pendingQc: "Chờ kiểm định",
          completed: "Đã hoàn thành",
          unknown: "Không rõ"
        },
        taskStatus: {
          ...
          paused: "Tạm dừng",
          waitingStock: "Chờ phụ tùng",
          pendingQc: "Chờ kiểm định",
          completed: "Hoàn thành",
          unknown: "Không rõ"
        },
        errors: {
          loadFailed: "Đã xảy ra lỗi khi kết nối với máy chủ."
        }
      },
      chat: {
        widgetTitle: "Hỗ trợ từ lễ tân",
        agentHandling: "{{name}} đang xử lý",
        directChat: "Trao đổi trực tiếp với xưởng",
        emptyState: "Gửi tin nhắn để được lễ tân hỗ trợ trực tiếp.",
        inputPlaceholder: "Nhập tin nhắn cho lễ tân...",
        viewQuoteDetail: "Xem chi tiết báo giá",
        quoteModal: {
          codeLabel: "Báo giá BG-{{id}}",
          title: "Chi tiết báo giá",
          customer: "Khách hàng",
          name: "Tên",
          phone: "SĐT",
          ...
          noNote: "Không có ghi chú.",
          total: "Tổng cộng",
          loadError: "Không tải được báo giá.",
          unknown: "Không rõ"
        },
        status: {
          pending: "Chờ duyệt",
      ...
      chatbot: {
        title: "Gara Assistant",
        subtitle: "Luôn sẵn sàng hỗ trợ",
        greeting: "Chào bạn! Mình là trợ lý ảo của Gara. Bạn cần hỗ trợ thông tin gì về dịch vụ, bảo hành hay cứu hộ không?",
        errorReply: "Xin lỗi, hệ thống đang bận. Bạn vui lòng thử lại sau nhé!",
        noReply: "Không có nội dung trả về.",
      ...
      booking: {
        ...
        selectBookingMode: "Chọn hình thức đặt lịch",
        aiConsultation: "Tham khảo tư vấn AI",
        serviceBooking: "Đặt lịch dịch vụ",
        savedVehicle: "Chọn xe đã lưu",
        addNewVehicle: "Thêm xe mới",
        directConsultation: "Tư vấn trực tiếp",
        consultationBooking: "Đặt lịch tư vấn",
        selectServiceOrRepair: "Chọn dịch vụ hoặc Sửa chữa lỗi",
        selectService: "Chọn dịch vụ",
        checkAndRepair: "Kiểm tra và sửa chữa lỗi",
        comboPackage: "Gói Combo",
        singleService: "Dịch vụ lẻ",
  ...
  en: {
    translation: {
      ...
      profile: {
        ...
        historyTooltip: "View details in Service History",
      ...
      history: {
        ...
        description: "Review your service history, maintenance records, and invoices.",
      ...
      appointments: {
        ...
        cancelFail: "Unable to cancel the appointment.",
        cancelError: "An error occurred while cancelling the appointment.",
        loadError: "Unable to fetch the appointment list.",
        loadErrorConnection: "An error occurred while connecting to the server.",
        loading: "Loading appointments...",
        loadErrorTitle: "Unable to load the appointment list",
        retry: "Retry",
        status: {
          confirmed: "Confirmed",
        ...
        historyDesc: "Track the status, time, and details of your service appointments.",
        bookNew: "Book New Appointment",
        serviceBookingsTab: "Service Bookings",
        supportBookingsTab: "Support Bookings",
        searchPlaceholder: "Search by vehicle, plate, or appointment code...",
        filter: {
          all: "All",
          confirmed: "Confirmed",
          inProgress: "In Progress",
        ...
        noSearchQueryResults: "Try changing your keyword or filter criteria.",
        noServiceBookings: "You don't have any service bookings at our Garage yet.",
        noSupportBookings: "You don't have any support or consultation bookings yet.",
        bookNowLink: "Book Now",
        requestSupportNow: "Request Support Now",
        supportRequestLabel: "Support Consultation Request",
        noDetailedNotes: "No detailed notes.",
        estCost: "Estimated Cost",
        consultationCost: "Consultation Cost",
        free: "Free",
        viewDetail: "View Details",
        cancel: "Cancel Appointment",
        apptDetailTitle: "Appointment Detail Slip",
        apptStatus: "Appointment Status:",
        apptTime: "Appointment Time",
        apptBay: "Service Bay",
        advisorSuffix: "(Advisor)",
        apptVehicle: "Registered Vehicle",
        apptServices: "Service Items",
        comboBadge: "Combo",
        singleServiceBadge: "Single Service",
        consultationContent: "Consultation Request Content",
        apptNotes: "Technical Notes / Requests",
        consultationCostLabel: "CONSULTATION COST:",
        apptTotal: "TOTAL ESTIMATED COST:",
        cancelAppt: "Cancel Appointment",
        consultationRequestLabel: "Consultation Request",
        comboAndSingle: "Combo & Single Services",
        comboPackageLabel: "Service Package (Combo)",
        supportRequest: "Technical Support Request",
        other: "Other",
        arranging: "Arranging",
      ...
      quoteTracking: {
        ...
        description: "Check quotes awaiting approval, part deposits, and processed quote history.",
        searchPlaceholder: "Search by quote code, vehicle, item, part...",
        filterAll: "All statuses",
        loading: "Loading quotes...",
        loadError: "Unable to load the quote list.",
        retry: "Retry",
        emptyTitle: "No quotes yet",
        emptyDesc: "Quotes related to your vehicle will be shown here.",
        table: {
          code: "Quote",
          customer: "Customer",
          vehicle: "Vehicle",
        ...
        modal: {
          ...
          status: "Status",
          awaitingDeposit: "Awaiting deposit for {{count}} part(s)",
          depositNeeded: "Deposit required: {{amount}}",
          approvedAt: "Approved at: {{date}}",
          createdAt: "Created Date",
          approvalMethod: "Approval method: {{method}}",
          itemsTitle: "Quote Items",
          itemsCount: "{{count}} item(s)",
          partsSection: "Parts ({{count}})",
          servicesSection: "Services ({{count}})",
          issueCol: "Issue",
          partCol: "Part",
          serviceCol: "Service",
          qtyCol: "Qty",
          unitPriceCol: "Unit Price",
          repairPriceCol: "Repair Price",
          totalCol: "Amount",
          customPartWaiting: "Custom-order part · Deposit required: {{amount}}",
          customPartPaid: "Custom-order part · Deposit paid",
          note: "Note",
          noNote: "No notes.",
          total: "Total",
          discussWithReception: "Discuss quote with staff",
          reject: "Decline",
        ...
        rejectModal: {
          ...
          placeholder: "Enter the reason you disagree with this quote...",
          cancel: "Cancel",
          confirm: "Confirm Decline",
          reasonRequired: "Please enter a reason for declining the quote."
        },
        depositModal: {
          title: "Deposit Payment",
          subtitle: "Scan the VietQR code to pay the deposit for custom-order parts.",
          amountDue: "Deposit Amount Due",
          quantityLabel: "Quantity: {{qty}} · 30% deposit",
          customer: "Customer",
          scanQr: "Scan VietQR Code",
          qrAlt: "VietQR deposit payment code",
          accountNumber: "Account Number",
          transferContent: "Transfer Note",
          waitingConfirm: "System is automatically waiting for deposit confirmation...",
          successTitle: "Deposit payment successful!",
          successDesc: "The deposit for quote {{code}} has been recorded.",
          close: "Close"
        },
        pdfModal: {
          title: "Quote {{code}} · PDF Preview",
          download: "Download",
          iframeTitle: "Quote PDF preview"
        },
        errors: {
          rejectFailed: "Unable to decline the quote.",
          approveFailed: "Unable to approve the quote.",
          pdfFailed: "Unable to generate the PDF file."
        }
      },
      tracking: {
        title: "Repair Progress Tracking",
        description: "Real-time updates on your vehicle's repair status.",
        loading: "Loading tracking data...",
        loadErrorTitle: "Unable to load data",
        retry: "Retry",
        emptyTitle: "No vehicles currently in the workshop",
        emptyDesc: "You currently have no repair orders in progress or recently completed.",
        bookNow: "Book Maintenance Now",
        filters: {
          active: "In Progress",
          completed: "Completed"
        },
        noVehicleFoundTitle: "No vehicle found",
        noVehicleActiveDesc: "Great! You don't have any vehicle currently under repair.",
        noVehicleCompletedDesc: "You don't have any vehicle that recently completed repair.",
        unknownPlate: "Unknown vehicle",
        vehicle: "Vehicle",
        plate: "License Plate",
        vehicleName: "Vehicle Name",
        returned: "Vehicle Returned",
        estimatedFinish: "Estimated Completion",
        workProgress: "Work Progress",
        awaitingHandover: "Final inspection before handover",
        itemsCompleted: "{{done}}/{{total}} items completed",
        repairItemsTitle: "Repair Items",
        unnamedItem: "Item #{{id}}",
        timeline: "Timeline",
        entryTime: "Vehicle Received",
        actualFinish: "Actual Completion",
        footerNote: "Data is automatically updated from the AGM Intelligent service workshop",
        orderStatus: {
          inspecting: "Inspecting",
          waitingForParts: "Awaiting Parts",
          inProgress: "In Repair",
          pendingQc: "Awaiting QC",
          completed: "Completed",
          unknown: "Unknown"
        },
        taskStatus: {
          ...
          inProgress: "In Progress",
          paused: "Paused",
          waitingStock: "Awaiting Parts",
          pendingQc: "Awaiting QC",
          completed: "Completed",
          unknown: "Unknown"
        },
        errors: {
          loadFailed: "An error occurred while connecting to the server."
        }
      },
      chat: {
        widgetTitle: "Front Desk Support",
        agentHandling: "{{name}} is handling this",
        directChat: "Chat directly with the workshop",
        emptyState: "Send a message to get direct support from the front desk.",
        inputPlaceholder: "Type a message to the front desk...",
        viewQuoteDetail: "View quote details",
        quoteModal: {
          codeLabel: "Quote BG-{{id}}",
          title: "Quote Details",
          customer: "Customer",
          name: "Name",
          phone: "Phone",
          ...
          noNote: "No notes.",
          total: "Total",
          loadError: "Unable to load the quote.",
          unknown: "Unknown"
        },
        status: {
          pending: "Pending",
      ...
      chatbot: {
        ...
        greeting: "Hi there! I'm the Gara virtual assistant. Do you need help with services, warranty, or roadside assistance?",
        errorReply: "Sorry, the system is currently busy. Please try again later!",
        noReply: "No content returned.",
      ...
      booking: {
        ...
        savedVehicle: "Select Saved Vehicle",
        addNewVehicle: "Add New Vehicle",
        directConsultation: "Direct Consultation",
        consultationBooking: "Consultation Booking",
        selectServiceOrRepair: "Select Service or Repair",
        selectService: "Select Service",
        checkAndRepair: "Inspection & Repair",
